...
export class ProfileProxy {
	...
	causesRecompilation(id: string, params: any, clientId: string, agent: any) {
		this.sendResult(
			id,
			{
				result: false
	...
	isSampling(id: string, params: any, clientId: string, agent: any) {
		this.sendResult(
			id,
			{
				result: true
	...
	hasHeapProfiler(id: string, params: any, clientId: string, agent: any) {
		this.sendResult(
			id,
			{
				result: true
	...
	getProfileHeaders(id: string, params: any, clientId: string, agent: any) {
		let headers = [];
	...
	takeHeapSnapshot(id: string, params: any, clientId: string, agent: any) {
		let uid = params.uid;
	...
	getProfile(id: string, params: any, clientId: string, agent: any) {
	...
	sendResult(id: string, res: any, clientId: string, agent: any) {
		agent.notifyClient(
			clientId,
			"profiler",
	...
	sendEvent(res: any, clientId: string, agent: any) {
		agent.notifyClient(clientId, "profiler", JSON.stringify(res));
	}

	start(id: string, params: any, clientId: string, agent: any) {
		let uid = params.uid;
	...
	stop(id: string, params: any, clientId: string, agent: any) {
		let uid = params.uid;
		agent.notifyById(uid, "profiler", {
			type: "CPU",
			action: "stop",
	...
	stopCallBack(res: any, clientId: string, agent: any) {
		let uid = res.msg.uid;
