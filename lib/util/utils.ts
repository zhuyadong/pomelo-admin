...
export function compareServer(
	server1: ServerInfo | SlaveRecord,
	server2: ServerInfo | SlaveRecord
) {
...
export function defaultAuthUser(msg: any, env: string, cb: Function) {
	let adminUser = null;
...
export function defaultAuthServerMaster(msg: any, env: string, cb: Function) {
	let id = msg["id"];
...
export function defaultAuthServerMonitor(msg: any, env: string, cb: Function) {
	let id = msg["id"];
	let type = msg["serverType"];
